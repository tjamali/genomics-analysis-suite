...
ROOT_DIR="/restricted/projectnb/leshlab/net/tjamali/projects"   # Root directory of the project
SCRIPTS_DIR="${ROOT_DIR}/RNA_pipeline/scripts"                  # Pipeline's scripts directory
...
MODEL_NAME="hac@v5.1.0"                                         # Dorado model name (e.g., hac@v5.1.0 or sup@v5.1.0)
